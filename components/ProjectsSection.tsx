  ...
  return (
    <div className="mb-12">
      <div className="flex items-baseline gap-3 mb-2">
        <span className="font-serif text-sm text-ink-3 border-b-2 border-accent pb-[2px]">02</span>
      ...
      {projects.length ? (
        ...
        <div className="text-[15px] text-ink-3 p-4 bg-surface border border-line rounded-[10px]">
