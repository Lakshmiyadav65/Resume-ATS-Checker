  ...
  return (
    <section className="border-b border-line py-20 md:py-[80px] pb-[60px] text-center">
      <div className="container max-w-page mx-auto px-6">
        <div className="text-[13px] text-ink-3 mb-[18px]">
        ...
        <p className="mt-[22px] text-[17px] text-ink-2 max-w-[560px] mx-auto">
          Most companies filter resumes with software before recruiters read them. Paste yours below to see exactly what to fix.
        </p>
        <div className="mt-10 flex justify-center gap-8 text-[13px] text-ink-3 flex-wrap">
...
function Step({ n, children }: { n: number; children: React.ReactNode }) {
  return (
    <div>
      <span className="inline-block w-[22px] h-[22px] border border-line rounded-full text-center leading-[20px] text-[11px] mr-2 text-ink">
        {n}
      </span>
      {children}
    </div>
