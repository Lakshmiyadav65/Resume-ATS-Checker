  ...
  return (
    <div className="mb-12">
      <div className="flex items-baseline gap-3 mb-2">
        <span className="font-serif text-[13px] text-ink-3 border-b-2 border-accent pb-[2px]">03</span>
        ...
        {lifts.map((l, i) => (
          ...
          >
            <div className="flex-1 text-sm">
              ...
              <small className="block text-[13px] text-ink-3 mt-1">{l.sub}</small>
            </div>
            <div className="text-sm font-semibold text-accent-2 whitespace-nowrap tabular-nums">
              +{l.gain}
            </div>
          </div>
        ))}
