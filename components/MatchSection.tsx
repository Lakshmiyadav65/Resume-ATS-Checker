  ...
  return (
    <div className="mb-12">
      <div className="flex items-baseline gap-3 mb-2">
        <span className="font-serif text-sm text-ink-3 border-b-2 border-accent pb-[2px]">01</span>
      ...
      <div className="mt-6">
        <h4 className="text-sm font-medium text-ink-2 mb-2.5">Keywords you have</h4>
        <div className="flex flex-wrap gap-2">
          {matched.length ? (
            ...
            <span className="text-sm text-ink-3">None of the job&apos;s keywords found yet.</span>
          )}
        </div>
      </div>

      <div className="mt-6">
        <h4 className="text-sm font-medium text-ink-2 mb-2.5">Keywords you&apos;re missing</h4>
        <div className="flex flex-wrap gap-2">
          {missing.length ? (
            missing.map((k) => (
            ...
            <span className="text-sm text-good">You&apos;ve got them all.</span>
          )}
        </div>
      </div>
    </div>
